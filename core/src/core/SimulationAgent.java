...
import disasterspread.input.DisasterSpreadFlowLoader;
        ...
        if (file.exists() && file.isDirectory()) {
            ...
            switch(domain){
                ...
                case TRANSPORTATION:
                    ...
                    break;
                case DISASTERSPREAD:
                    DisasterSpreadFlowLoader dFL=new DisasterSpreadFlowLoader(flowNetwork, columnSeparator, missingValue);
                    if (new File(experimentInputFilesLocation+timeToken+nodesFlowLocation).exists())

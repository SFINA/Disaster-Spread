 ...
 * @author dinesh
 */
public class DisasterSpreadAgentNew extends SimulationAgentNew {

    //private HashMap<String,ArrayList<Double>> nodeHealthHistory;
    private double timeStep = 0.1;
    private static final Logger logger = Logger.getLogger(DisasterSpreadAgentNew.class);
    ...
    public DisasterSpreadAgentNew(String experimentID,
            Time bootstrapTime,
